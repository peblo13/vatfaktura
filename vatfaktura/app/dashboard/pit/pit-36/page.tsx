...
export default function Pit36ListPage() {
  ...
  useEffect(() => {
    ...
    if (!isLoading && !user) {
      ...
      const userDeclarations = getPitDeclarationsByUser(user.id).filter(d => d.type === 'PIT-36')
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold">PIT-36</h1>
            </div>
          </div>
          <Link href="/dashboard/pit/pit-36/create">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="border border-border/40 bg-card/30 rounded-lg p-6">
          <h2 className="text-lg font-bold mb-6">Wszystkie Deklaracje PIT-36</h2>

          {declarations.length === 0 ? (
            <div className="text-center py-12">
              <FileText className="w-12 h-12 text-muted-foreground/30 mx-auto mb-4" />
              <p className="text-muted-foreground mb-4">Brak deklaracji PIT-36</p>
              <Link href="/dashboard/pit/pit-36/create" className="text-primary hover:underline">
